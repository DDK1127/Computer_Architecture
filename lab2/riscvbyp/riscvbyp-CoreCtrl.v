...
(
  ...
  output reg  [1:0]   rs1_byp_sel_Dhl, // add to bypass signal to Decode stage
  output reg  [1:0]   rs2_byp_sel_Dhl, // add to bypass signal to Decode stage
  ...
  /*
    bcs Register File is 
  */

  localparam BYP_REG = 2'b00; // no bypassing 
  localparam BYP_X   = 2'b01; // bypassing X (Execute) stage
  localparam BYP_M   = 2'b10; // bypassing M (Memory) stage
  localparam BYP_W   = 2'b11; // bypassing W (Write) stage
