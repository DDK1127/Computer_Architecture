...
module sim;
  ...
  initial begin
    ...
    case ( op_type )
      ...
      "mulh"    : src_msg_fn = `IMULDIV_MULDIVREQ_MSG_FUNC_MULH;
      "mulhu"   : src_msg_fn = `IMULDIV_MULDIVREQ_MSG_FUNC_MULHU;
      "mulhsu"  : src_msg_fn = `IMULDIV_MULDIVREQ_MSG_FUNC_MULHSU;
      ...
      default:
       begin
        $display( "Illegal operation! {mul,mulh,mulhu,mulhsu,div,divu,rem,remu}" );
        $finish;
       end
  ...
  always @ ( posedge clk ) begin
    ...
    // Result is ready, display output and cycle count
      ...
      case ( src_msg_fn )
        ...
        `IMULDIV_MULDIVREQ_MSG_FUNC_MULH    : $display( "%h h %h = %h", src_msg_a, src_msg_b, sink_msg[63:32] );
        `IMULDIV_MULDIVREQ_MSG_FUNC_MULHU   : $display( "%h hu %h = %h", src_msg_a, src_msg_b, sink_msg[63:32] );
        `IMULDIV_MULDIVREQ_MSG_FUNC_MULHSU  : $display( "%h hs %h = %h", src_msg_a, src_msg_b, sink_msg[63:32] );
