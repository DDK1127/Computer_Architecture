...
module tester;
  ...
  begin
    ...
    // Create mulh messages

    t1_do_test( mulh,  32'd00, 32'd01 );
    t1_do_test( mulh,  32'd42, 32'd01 );
    t1_do_test( mulh,  32'd18, 32'd68 );

     // Create mulhu messages

    t1_do_test( mulhu,  32'd00, 32'd01 );
    t1_do_test( mulhu,  32'd42, 32'd01 );
    t1_do_test( mulhu,  32'd18, 32'd68 );

     // Create mulhsu messages

    t1_do_test( mulhsu,  32'd00, 32'd01 );
    t1_do_test( mulhsu,  32'd42, 32'd01 );
    t1_do_test( mulhsu,  32'd18, 32'd68 );
  ...
  begin
    ...
    t2_do_test( mulh,  32'd00, 32'd01 );
    t2_do_test( mulh,  32'd42, 32'd01 );
    t2_do_test( mulh,  32'd18, 32'd68 );

     // Create mulhu messages

    t2_do_test( mulhu,  32'd00, 32'd01 );
    t2_do_test( mulhu,  32'd42, 32'd01 );
    t2_do_test( mulhu,  32'd18, 32'd68 );

     // Create mulhsu messages

    t2_do_test( mulhsu,  32'd00, 32'd01 );
    t2_do_test( mulhsu,  32'd42, 32'd01 );
    t2_do_test( mulhsu,  32'd18, 32'd68 );
