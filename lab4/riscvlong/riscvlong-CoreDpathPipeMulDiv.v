...
(
  ...
  wire [63:0] product_unsigned  = a_reg * b_reg;
  wire [63:0] product_sign_helf = a_unsign * b_reg;
  ...
  wire [63:0] product_mulhsu
    = ( a_reg[31] ) ? ( ~product_sign_helf + 1'b1)
                    : product_sign_helf;
  ...
  wire [63:0] result0
    ...
    : ( fn_reg == `IMULDIV_MULDIVREQ_MSG_FUNC_MULH )  ? product
    : ( fn_reg == `IMULDIV_MULDIVREQ_MSG_FUNC_MULHU)  ? product_unsigned
    : ( fn_reg == `IMULDIV_MULDIVREQ_MSG_FUNC_MULHSU) ? product_mulhsu
